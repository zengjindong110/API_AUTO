...
class TestCustomerUpload(unittest.TestCase, RequestApi):
    ...
    def setUpClass(cls) -> None:
        ...
        for index in range(len(all_request_data)):
            ...
            advertiserAccountId = cls().request(advertiserAccountId_params[0]).json()["records"][0]["id"]
            # 获取所有的渠道id
            ...
            channel_list = [i["id"] for i in cls().request(get_channel_data[0]).json()["records"]]
    ...
    def test_02_configure_upload(self, all_upload_data):
        print(1112,all_upload_data)
        #
